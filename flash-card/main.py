...
def next_card():
    # Make current card accessible to flip_card()
    global current_card, flip_timer

    # Cancel previous timer before setting up new card
    ...
    # in the mainloop() should not create additional delayed loops time.sleep
